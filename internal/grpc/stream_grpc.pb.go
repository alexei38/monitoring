...
type StreamServiceClient interface {
	FetchResponse(ctx context.Context, in *ClientRequest, opts ...grpc.CallOption) (StreamService_FetchResponseClient, error)
}
...
func (c *streamServiceClient) FetchResponse(ctx context.Context, in *ClientRequest, opts ...grpc.CallOption) (StreamService_FetchResponseClient, error) {
...
func (x *streamServiceFetchResponseClient) Recv() (*Metrics, error) {
	m := new(Metrics)
...
type StreamServiceServer interface {
	FetchResponse(*ClientRequest, StreamService_FetchResponseServer) error
...
func (UnimplementedStreamServiceServer) FetchResponse(*ClientRequest, StreamService_FetchResponseServer) error {
...
func (x *streamServiceFetchResponseServer) Send(m *Metrics) error {
